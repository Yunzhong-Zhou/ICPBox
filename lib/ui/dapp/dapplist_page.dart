...
//文章
class DappListPage extends StatefulWidget {
  const DappListPage({Key? key,String? type}) : super(key: key);

  @override
  _DappListPageState createState() => _DappListPageState();
}

class _DappListPageState extends State<DappListPage> with AutomaticKeepAliveClientMixin{
